...
> **说明**：本插件是 **glacierzzz26** 维护的定制副本，基于
> [jarrodwatts/claude-hud](https://github.com/jarrodwatts/claude-hud)（作者 Jarrod Watts，MIT 许可）。
> 上游项目与原始文档：https://github.com/jarrodwatts/claude-hud

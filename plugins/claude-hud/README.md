...
> **Note:** This is a customized copy maintained by **glacierzzz26**, based on
> [jarrodwatts/claude-hud](https://github.com/jarrodwatts/claude-hud) by Jarrod Watts
> (MIT License). Upstream project and original docs:
